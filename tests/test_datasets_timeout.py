...
@pytest.mark.timeout(6.5)  # Repeat 10 times, takes ~0.6 second to instantiate FrameSceneDataset.
...
@pytest.mark.timeout(6.5)  # Repeat 10 times, takes ~0.6 second to instantiate SynchronizedSceneDataset.
