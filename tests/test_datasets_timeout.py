# TODO: merge this test into tests/test_datasets.py once it migrats to pytest.
import os
...
@pytest.mark.timeout(6.5)  # Repeat 10 times, takes ~0.63 second to instantiate FrameSceneDataset.
...
@pytest.mark.timeout(6.5)  # Repeat 10 times, takes ~0.63 second to instantiate SynchronizedSceneDataset.
