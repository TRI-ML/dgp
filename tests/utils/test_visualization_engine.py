...
def test_visualize_dataset_3d():
    ...
    visualize_dataset_3d(dataset=dataset, camera_datum_names=['CAMERA_01'],
    lidar_datum_names=['LIDAR'], radar_datum_names=[], output_video_file="./test_3d_vis.avi")
...
def test_visualize_dataset_2d():
    ...
    visualize_dataset_2d(dataset=dataset, camera_datum_names=['CAMERA_01'], 
    caption_fn=dummy_caption, output_video_file="./test_2d_vis.avi")
...
def test_visualize_dataset_sample_3d():
    ...
    visualize_dataset_sample_3d(dataset=dataset, scene_idx=0, sample_idx=0)