...
def test_visualize_dataset_sample_3d():
    ...
    result = visualize_dataset_sample_3d(dataset=dataset, scene_idx=0, sample_idx=0)

    #It's currently hard to do a value compare, since there's some amount of drift in data,
