...
@pytest.mark.parametrize("num_colors,in_bgr,cmap,expected_map", [
    (5, False, 'tab20', [(31,   119,   180),
                         (174,   199, 232),
                         (255,   127,   14),
                         (255,   187,   120),
                         (44,  160,   44),
...
def test_get_unique_colors(num_colors, in_bgr, cmap, expected_map):
    ...
    '''
    assert get_unique_colors(num_colors=num_colors,
                             in_bgr=in_bgr, cmap=cmap) == expected_map
