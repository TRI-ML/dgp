...
FileDatum = _reflection.GeneratedProtocolMessageType('FileDatum', (_message.Message,), dict(
...
SelfDescribingFile = _reflection.GeneratedProtocolMessageType('SelfDescribingFile', (_message.Message,), dict(
