...
from dgp.proto import map_pb2 as dgp_dot_proto_dot_map__pb2
...
_DATUMVALUE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='traffic_light_stata', full_name='dgp.proto.DatumValue.traffic_light_stata', index=4,
...
_DATUMVALUE.fields_by_name['traffic_light_stata'].message_type = dgp_dot_proto_dot_map__pb2._TRAFFICLIGHTSTATE
...
_DATUMVALUE.oneofs_by_name['datum_oneof'].fields.append(
  _DATUMVALUE.fields_by_name['traffic_light_stata'])
_DATUMVALUE.fields_by_name['traffic_light_stata'].containing_oneof = _DATUMVALUE.oneofs_by_name['datum_oneof']
