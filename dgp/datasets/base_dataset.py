...
from dgp import (
    ANNOTATION_KEY_TO_TYPE_ID, ANNOTATION_TYPE_ID_TO_KEY, AUTOLABEL_FOLDER, CALIBRATION_FOLDER, DGP_CACHE_DIR,
    ONTOLOGY_FOLDER, SCENE_JSON_FILENAME
)
...
class BaseDataset:
    ...
    def list_datum_names_available_in_all_scenes(self):
        ...
        """
        with Pool(cpu_count()) as proc:
            available_datum_names = set(proc.map(BaseDataset._datum_names_for_scenes, self.scenes))
