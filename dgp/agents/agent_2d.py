...
class AgentSnapshot2DList(AgentSnapshotList):
    ...
    def __init__(self, ontology, boxlist):
        ...
        assert isinstance(self._ontology, BoundingBoxOntology), "Trying to load AgentSnapshotList with wrong type of " \
                                                                "ontology!"
    ...
    @classmethod
    def load(cls, agent_snapshots_2d, ontology, feature_ontology_table):
        ...
        Parameters
        ----------
        agent_snapshots_2d: dgp.proto.agent.AgentsSlice.agent_snapshots or dgp.proto.agent.AgentTrack.agent_snapshots
        ...
        """
        boxlist = []
        for agent_snapshot_2d in agent_snapshots_2d:
            ...
            boxlist.append(BoundingBox2D(
                box=np.float32([agent_snapshot_2d.agent_snapshot_2D.box.x, agent_snapshot_2d.agent_snapshot_2D.box.y,
                                agent_snapshot_2d.agent_snapshot_2D.box.w, agent_snapshot_2d.agent_snapshot_2D.box.h]),

                class_id=ontology.class_id_to_contiguous_id[agent_snapshots_2d.agent_snapshots_2D.class_id],
                ...
                attributes=dict(
                    [(feature_ontology.id_to_name[feature_id], feature) for feature_id, feature in
                     enumerate(agent_snapshot_2d.agent_snapshot_2D.features)]),
            ))
