...
class PanopticSegmentation2DAnnotation(Annotation):
    ...
    def __init__(self, ontology, panoptic_image, index_to_label, panoptic_image_dtype=DEFAULT_PANOPTIC_IMAGE_DTYPE):
        ...
        # TODO (allan.raventos): check type and structure of `index_to_label`
    ...
    def load(cls, annotation_file, ontology, panoptic_image_dtype=DEFAULT_PANOPTIC_IMAGE_DTYPE):
        ...
        if len(panoptic_image.shape) == 3:
            ...
            # TODO (dennis.park) discuss with PD on changing this to np.uint16 image.
            _L = panoptic_image
    ...
    def render(self):
        """TODO (allan.raventos): Return a rendering of the annotation"""

    @property
    def hexdigest(self):
        """Reproducible hash of annotation."""
        # NOTE (allan.raventos): for now just hashing `self.panoptic_image`. Could have a hash
