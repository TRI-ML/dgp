...
_PARALLELDOMAINFRAMEMETADATA_ATTRIBUTESENTRY = _descriptor.Descriptor(
  name='AttributesEntry',
  full_name='dgp.proto.ParallelDomainFrameMetadata.AttributesEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='dgp.proto.ParallelDomainFrameMetadata.AttributesEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='dgp.proto.ParallelDomainFrameMetadata.AttributesEntry.value', index=1,
...
_PARALLELDOMAINFRAMEMETADATA = _descriptor.Descriptor(
  name='ParallelDomainFrameMetadata',
  full_name='dgp.proto.ParallelDomainFrameMetadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='attributes', full_name='dgp.proto.ParallelDomainFrameMetadata.attributes', index=0,
  ...
  nested_types=[_PARALLELDOMAINFRAMEMETADATA_ATTRIBUTESENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_PARALLELDOMAINFRAMEMETADATA_ATTRIBUTESENTRY.containing_type = _PARALLELDOMAINFRAMEMETADATA
_PARALLELDOMAINFRAMEMETADATA.fields_by_name['attributes'].message_type = _PARALLELDOMAINFRAMEMETADATA_ATTRIBUTESENTRY
...
DESCRIPTOR.message_types_by_name['ParallelDomainFrameMetadata'] = _PARALLELDOMAINFRAMEMETADATA
...
ParallelDomainFrameMetadata = _reflection.GeneratedProtocolMessageType('ParallelDomainFrameMetadata', (_message.Message,), dict(

  AttributesEntry = _reflection.GeneratedProtocolMessageType('AttributesEntry', (_message.Message,), dict(
    DESCRIPTOR = _PARALLELDOMAINFRAMEMETADATA_ATTRIBUTESENTRY,
    __module__ = 'dgp.contribs.pd.metadata_pb2'
    # @@protoc_insertion_point(class_scope:dgp.proto.ParallelDomainFrameMetadata.AttributesEntry)
    ))
  ,
  DESCRIPTOR = _PARALLELDOMAINFRAMEMETADATA,
  __module__ = 'dgp.contribs.pd.metadata_pb2'
  # @@protoc_insertion_point(class_scope:dgp.proto.ParallelDomainFrameMetadata)
  ))
_sym_db.RegisterMessage(ParallelDomainFrameMetadata)
_sym_db.RegisterMessage(ParallelDomainFrameMetadata.AttributesEntry)
...
_PARALLELDOMAINFRAMEMETADATA_ATTRIBUTESENTRY._options = None
