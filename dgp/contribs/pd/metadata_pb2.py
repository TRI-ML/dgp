...
_GENERICMETADATA_METADATAENTRY = _descriptor.Descriptor(
  name='MetadataEntry',
  full_name='dgp.proto.GenericMetadata.MetadataEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='dgp.proto.GenericMetadata.MetadataEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='dgp.proto.GenericMetadata.MetadataEntry.value', index=1,
...
_GENERICMETADATA = _descriptor.Descriptor(
  ...
  full_name='dgp.proto.GenericMetadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='metadata', full_name='dgp.proto.GenericMetadata.metadata', index=0,
  ...
  nested_types=[_GENERICMETADATA_METADATAENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_GENERICMETADATA_METADATAENTRY.containing_type = _GENERICMETADATA
_GENERICMETADATA.fields_by_name['metadata'].message_type = _GENERICMETADATA_METADATAENTRY
...
GenericMetadata = _reflection.GeneratedProtocolMessageType('GenericMetadata', (_message.Message,), dict(

  MetadataEntry = _reflection.GeneratedProtocolMessageType('MetadataEntry', (_message.Message,), dict(
    DESCRIPTOR = _GENERICMETADATA_METADATAENTRY,
    __module__ = 'dgp.contribs.pd.metadata_pb2'
    # @@protoc_insertion_point(class_scope:dgp.proto.GenericMetadata.MetadataEntry)
    ))
  ,
  DESCRIPTOR = _GENERICMETADATA,
  __module__ = 'dgp.contribs.pd.metadata_pb2'
  # @@protoc_insertion_point(class_scope:dgp.proto.GenericMetadata)
  ))
_sym_db.RegisterMessage(GenericMetadata)
_sym_db.RegisterMessage(GenericMetadata.MetadataEntry)
...
_GENERICMETADATA_METADATAENTRY._options = None
